...
### Simulation 2
dat <- generate.data.ext(dimensions = 2, 
                     n1 = 50, 
                     n2 = 50, 
                     n3 = 0, 
                     n4 = 0,
...
# map(1:n_chain, function(m) {
#   p <- plot.simulation(dat, res_list[[m]], coord_flip = TRUE)
#   multiplot(plotlist = p, cols = 2)
# })

saveRDS(dat, "~/fasrcrepo/l1ideal/data/simulation/sim2_gaussian_nonuniform_dat.rds")
saveRDS(res_list, "~/fasrcrepo/l1ideal/data/simulation/sim2_gaussian_nonuniform_res_list.rds")